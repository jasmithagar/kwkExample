<script>
  ...
  import TestSection from "./sections/Introduction.svelte";
    import WhiteManDollar from "./sections/WhiteManDollar.svelte";
    import Introduction from "./sections/Introduction.svelte";
    import WhiteWomanDollar from "./sections/WhiteWomanDollar.svelte";
    import MoreDollars from "./sections/MoreDollars.svelte";
